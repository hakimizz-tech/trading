...
- Max drawdown: -16.24%.
- Rebalance count: 109.
- Latest target allocation: `SPY` 28.02%, `IWM` 19.88%, `QQQ` 18.64%, `EFA` 20.24%, `EEM` 13.22%.
...
The strategy now uses the shared `visualization/` package through `strategies.RisingAssest.reporting`.
